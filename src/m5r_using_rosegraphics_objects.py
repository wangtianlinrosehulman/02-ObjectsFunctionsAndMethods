...
#            window = rg.Rosewindow(100,100,'window')
#
...
#               window = rg.Rosewindow(width,100,'heading')
#
...
#            after drawing everything at last. after this method, or the window will directly close
#
